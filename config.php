...
$servers->setValue('server','name','csp ldap');
...
$servers->setValue('server','host','172.16.50.9');
...
$servers->setValue('server','base',array('dc=csplab,dc=local'));
...
/* The DN of the user for phpLDAPadmin to bind with. For anonymous binds or
   ...
   binds. */
$servers->setValue('login','bind_id','cn=admin,dc=csplab,dc=local');
#  $servers->setValue('login','bind_id','cn=Manager,dc=example,dc=com');

/* Your LDAP password. If you specified an empty bind_id above, this MUST also
   be blank. */
$servers->setValue('login','bind_pass','brownuser01');
